                ...
                {activeTrips.slice(0, 5).map((trip) => {
                  ...
                  return (
                    <button
                      ...
                      className="group w-full text-start flex items-center gap-3 rounded-xl border border-gray-200 bg-white p-3 shadow-sm transition-all hover:shadow-md active:scale-[0.99] dark:border-slate-700 dark:bg-slate-800"
                    >
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-stone-100 dark:bg-stone-800">
                        <Map className="h-5 w-5 text-stone-500 dark:text-stone-400" />
                      </div>
                      ...
                      <ChevronRight className="h-4 w-4 shrink-0 text-stone-300 group-hover:text-stone-500 transition-colors dark:text-stone-600 rtl:rotate-180" />
                    </button>
                  );
                })}
              </div>
              ...
              <div className="space-y-2">
                {recentBookings.map((booking) => {
                  ...
                  return (
                    <div
                      key={booking.id}
                      className="flex items-center gap-3 rounded-lg border border-gray-100 bg-stone-50/50 p-2.5 dark:border-slate-700 dark:bg-slate-800/50"
                    >
                      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-stone-100 dark:bg-stone-700">
          ...
          <Card variant="elevated" padding="lg">
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between rounded-lg border border-gray-100 bg-stone-50/50 p-3 dark:border-slate-700 dark:bg-slate-800/50">
                  <span className="text-body-sm text-stone-600 dark:text-stone-400">
                    {t("متوسط قيمة الحجز", "Avg. Booking Value")}
                  </span>
                  <span className="text-body-sm font-bold text-stone-900 dark:text-white tabular-nums" dir="ltr">
                ...
                <div className="flex items-center justify-between rounded-lg border border-gray-100 bg-stone-50/50 p-3 dark:border-slate-700 dark:bg-slate-800/50">
                  ...
                  <span className="text-body-sm font-bold text-stone-900 dark:text-white tabular-nums">
