          ...
          <>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="flex items-center gap-3 text-[11px] text-slate-500 dark:text-neutral-300/60 mt-0.5">
                            {departure && (
            ...
            <Card variant="outlined" padding="lg" className="border-sky-200/70 dark:border-sky-800/45">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-body-sm text-slate-700 dark:text-neutral-200">
                    {t(
