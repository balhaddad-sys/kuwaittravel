    ...
    <>
      ...
      <Card variant="elevated" padding="lg" className="sacred-pattern overflow-hidden">
        <div className="text-center mb-6 sm:mb-8">
          <div className="mx-auto mb-3 sm:mb-4 flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-full border-2 border-teal-300/80 bg-teal-700 shadow-[0_0_0_6px_rgba(37,99,235,0.12)]">
