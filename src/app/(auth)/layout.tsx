  ...
  return (
    <div className="dark relative min-h-screen overflow-hidden bg-[#0B1120]">
      ...
      <div
        ...
        style={{ background: "radial-gradient(ellipse 80% 60% at 50% 20%, rgba(14,165,233,0.08) 0%, transparent 60%)" }}
      />
      <div className="fixed -top-32 -left-32 h-80 w-80 rounded-full bg-sky-400/8 blur-3xl lg:hidden" />
      <div className="fixed bottom-20 -right-20 h-64 w-64 rounded-full bg-violet-400/10 blur-3xl lg:hidden" />

      {/* Full-bleed gradient left panel (desktop only) */}
      <div className="hidden lg:fixed lg:inset-y-0 lg:start-0 lg:flex lg:w-[52%] lg:flex-col lg:overflow-hidden">
        ...
        <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse 70% 50% at 60% 30%, rgba(139,92,246,0.1) 0%, transparent 65%)" }} />
      ...
      <div className="relative z-10 flex min-h-screen flex-col lg:ms-[52%]">
        <header className="flex items-center justify-between px-5 py-5 sm:px-8">
          ...
          <div className="flex items-center gap-2.5 lg:invisible">
            ...
            <div>
              <p className="text-sm font-bold text-white">Rahal</p>
              <p className="text-[11px] text-sky-300/70">{t("رحلات زيارية", "Pilgrimage Travel")}</p>
            </div>
          </div>
          <LanguageToggle />
        </header>
