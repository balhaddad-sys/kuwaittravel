  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gray-50">
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:start-0 lg:flex lg:w-[52%] lg:flex-col lg:overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-teal-800 via-teal-700 to-teal-500" />
        {/* Decorative orbs */}
        <div className="absolute -top-32 -start-32 h-80 w-80 rounded-full bg-teal-400/20 blur-3xl" />
        <div className="absolute top-1/3 -end-20 h-64 w-64 rounded-full bg-coral-400/20 blur-3xl" />
        <div className="absolute bottom-10 start-10 h-48 w-48 rounded-full bg-teal-300/20 blur-2xl" />
        ...
        <div className="relative flex flex-1 flex-col justify-between p-10 xl:p-14">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-teal-200">{t("رحلات زيارية", "Pilgrimage Travel")}</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-8 flex items-center gap-5">
              <div className="flex items-center gap-2 text-sm text-teal-100">
                <span className="flex h-7 w-7 items-center justify-center rounded-full bg-coral-400/20">
                  <BadgeCheck className="h-3.5 w-3.5 text-coral-300" />
                </span>
          ...
          <blockquote className="rounded-2xl border border-white/15 bg-white/10 p-5 backdrop-blur-sm">
            ...
            <footer className="mt-3 flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[11px] text-teal-200">{t("مسافر موثق", "Verified traveler")}</p>
              </div>
            </footer>
          </blockquote>
        </div>
