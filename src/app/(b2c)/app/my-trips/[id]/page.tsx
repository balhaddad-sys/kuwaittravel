    ...
    <div className="min-h-screen bg-surface-muted dark:bg-surface-dark">
      ...
      <Container className="space-y-6 py-6">
        ...
        <Card variant="outlined" padding="md">
          <h3 className="mb-3 text-heading-sm font-bold text-slate-900 dark:text-white">
        ...
        <Card variant="outlined" padding="md">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between border-b border-surface-border py-2 dark:border-surface-dark-border">
              <span className="text-body-md text-slate-500">{t("المبلغ الإجمالي", "Total Amount")}</span>
              <span className="text-body-md font-bold text-slate-900 dark:text-white">
                {booking.totalKWD} {t("د.ك", "KWD")}
              </span>
            </div>
            {booking.discountKWD > 0 && (
              <div className="flex items-center justify-between border-b border-surface-border py-2 dark:border-surface-dark-border">
                <span className="text-body-md text-slate-500">{t("الخصم", "Discount")}</span>
            ...
            <div className="flex items-center justify-between border-b border-surface-border py-2 dark:border-surface-dark-border">
              <span className="text-body-md text-slate-500">{t("المدفوع", "Paid")}</span>
            ...
            {booking.remainingKWD > 0 && (
              <div className="flex items-center justify-between py-2">
                <span className="text-body-md text-slate-500">{t("المتبقي", "Remaining")}</span>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-body-sm font-medium text-slate-900 dark:text-white">
                    ...
                    <div className="text-end">
                      <p className="text-body-sm font-bold text-slate-900 dark:text-white">
