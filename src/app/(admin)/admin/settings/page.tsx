    ...
    <>
      ...
      <Container size="md" className="py-6 space-y-6">
        <Card variant="elevated" padding="lg" className="space-y-4">
          <h3 className="text-heading-sm font-bold text-navy-900 dark:text-white">إعدادات العمولة</h3>
          ...
          <Button variant="primary" leftIcon={<Save className="h-4 w-4" />}>حفظ</Button>
        </Card>

        <Card variant="elevated" padding="lg" className="space-y-4">
          <h3 className="text-heading-sm font-bold text-navy-900 dark:text-white">إعدادات المدفوعات</h3>
