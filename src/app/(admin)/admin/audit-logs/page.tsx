...
const actionConfigMap: Record<string, ActionConfig> = {
  ...
  dispute_closed: {
    ...
    color: "text-slate-600 dark:text-neutral-400/70",
  },
  trip_published: {
      ...
      <Container className="py-3 sm:py-6 space-y-3 sm:space-y-4">
        ...
        <div className="grid gap-3 sm:grid-cols-[1fr_auto]">
          <SearchInput
            ...
            onSearch={setSearch}
          />
          <div className="rounded-[var(--radius-input)] border border-surface-border/90 bg-white/80 px-4 py-2.5 text-body-sm text-slate-500 backdrop-blur-sm dark:border-surface-dark-border/90 dark:bg-surface-dark-card/80 dark:text-neutral-400/70 flex items-center gap-2">
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 mt-1 text-[11px] text-slate-400 dark:text-neutral-400/60">
                            <span>
                    ...
                    {isExpanded && hasChanges && (
                      <div className="px-4 pb-3 ps-[3.25rem]">
                        <div className="rounded-lg border border-surface-border/70 bg-slate-50/80 p-3 dark:border-surface-dark-border/70 dark:bg-white/[0.02]">
                          <h5 className="text-[11px] font-semibold uppercase tracking-wide text-slate-400 dark:text-neutral-400/60 mb-2">
                            {t("\u0627\u0644\u062a\u063a\u064a\u064a\u0631\u0627\u062a", "Changes")}
                          </h5>
