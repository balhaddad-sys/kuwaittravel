      ...
      <Sidebar
        ...
        footer={
          <div className="space-y-1.5">
            ...
            <Link href="/portal/dashboard" className="flex items-center gap-2.5 rounded-[var(--radius-lg)] px-2.5 py-2 text-body-sm text-stone-600 transition-colors hover:bg-surface-light dark:text-stone-400 dark:hover:bg-surface-dark">
