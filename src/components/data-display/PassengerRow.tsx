  ...
  return (
    <div className={cn(
      ...
      <div className="flex-1 min-w-0">
        <p className="text-body-md font-medium text-slate-900 dark:text-white truncate">{name}</p>
        {phone && (
          <p className="text-body-sm text-slate-400 flex items-center gap-1">
      ...
      {onAction && (
        <button onClick={onAction} className="shrink-0 rounded-lg p-1.5 text-slate-400 hover:bg-surface-muted transition-colors">
