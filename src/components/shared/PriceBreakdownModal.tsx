      ...
      <div className="space-y-3">
        {items.map((item, i) => (
          <div key={i} className="flex items-center justify-between">
            ...
            <span className={cn(
              ...
              item.type === "discount" ? "text-indigo-600 dark:text-indigo-400" : "text-gray-900 dark:text-white"
            )}>
        ...
        <div className="border-t-2 border-gray-200 pt-3 dark:border-gray-700">
          <div className="flex items-center justify-between">
            ...
            <span className="font-numbers text-heading-md font-bold text-indigo-700 dark:text-indigo-400">
              {formatKWD(total)}
            </span>
          </div>
        </div>
