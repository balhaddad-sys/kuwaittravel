...
function CampaignCard({
  ...
  return (
    <Card variant="elevated" padding="none" hoverable onClick={onClick} className={className}>
      <div className="relative h-28 overflow-hidden rounded-t-[var(--radius-card)] bg-navy-100 dark:bg-navy-800">
      ...
      <div className="relative px-4 pb-4">
        ...
        <p className="mt-1 line-clamp-2 text-body-sm text-navy-500 dark:text-navy-300">{description}</p>
