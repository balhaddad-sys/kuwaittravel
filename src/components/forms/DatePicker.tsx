  ...
  ({ className, label, error, hint, id, ...props }, ref) => {
    ...
    return (
      <div className="flex flex-col gap-1.5">
        {label && (
          <label htmlFor={inputId} className="text-label font-medium text-stone-700 dark:text-stone-200">
            {label}
          </label>
        )}
        <div className="relative">
          <input
            ...
            {...props}
          />
          <Calendar className="pointer-events-none absolute end-3 top-1/2 h-4 w-4 -translate-y-1/2 text-stone-400" />
        </div>
